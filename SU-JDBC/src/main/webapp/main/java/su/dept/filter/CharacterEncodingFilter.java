...
//리소스에 대한 요청이나 리소스의 응답에 대해 필터링 작업을 수행하는 객체인 Filter 인터페이스로 클래스를 생성한다.
public class CharacterEncodingFilter implements Filter { // 서블릿 컨테이너에서 사용하는 필터 구성 객체를 선언한다.
	FilterConfig config;
