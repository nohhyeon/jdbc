						...
						<div class="card-body">
							<form action="./DeptUpdate" method="post" id="sign_dept">
								<fieldset>
									...
									<div class="form-group row">
										<label for="dname" class="ml-sm-3 col-form-label"> 부서
											이름 </label>
										<div class="ml-sm-3">
									...
									<div class="form-group row">
										<label for="loc" class="ml-sm-3 col-form-label"> 부서 지역
										</label>
										<div class="ml-sm-3">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<a
										href="./DeptDelete?deptno=<%=request.getParameter("deptno") %>"
										class="btn btn-danger btn-block"> 부서 삭제 </a>
								</div>
							</div>
						</div>
					</div>
